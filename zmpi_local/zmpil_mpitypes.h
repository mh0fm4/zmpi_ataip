...
#ifndef __ZMPIL_MPITYPES_H__
#define __ZMPIL_MPITYPES_H__


/* sophisticated solution based on MPITypes, Ross et al., "Processing MPI Datatypes Outside MPI" */


#endif /* __ZMPIL_MPITYPES_H__ */
