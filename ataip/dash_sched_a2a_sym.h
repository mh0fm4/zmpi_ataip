...
#ifndef __DASH_SCHED_A2A_SYM_H__
#define __DASH_SCHED_A2A_SYM_H__


#include "dash_core.h"


dsint_t ds_sched_a2a_sym_create(ds_sched_t *sched);
dsint_t ds_sched_a2a_sym_destroy(ds_sched_t *sched);


#endif /* __DASH_SCHED_A2A_SYM_H__ */
